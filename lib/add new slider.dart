...
class add_new_slider extends StatefulWidget {
  const add_new_slider({super.key});

  @override
  State<add_new_slider> createState() => _add_new_sliderState();
}

class _add_new_sliderState extends State<add_new_slider> {
  final firestore = FirebaseFirestore.instance.collection('slider');
      ...
      for (ImageFile image in images) {
        if (image.bytes != null) {
          ...
          FirebaseStorage.instance.ref().child(
            'slider_images/${id.text.toString()}/$fileName',
          );
